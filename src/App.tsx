...
function AppContent() {
  return (
    <Box w="100%" display="flex" flexDir="column" alignItems="center" p={4}>
      <Heading maxW="lg" mb={2} display="flex" flexDir="column" alignItems="center">
        <Image src="assets/ac_header.png" />
      </Heading>
      <Box w="100%">
        <Tabs.Root defaultValue="how-it-works" justify="center" variant="outline">
          <Tabs.List gap={2}>
